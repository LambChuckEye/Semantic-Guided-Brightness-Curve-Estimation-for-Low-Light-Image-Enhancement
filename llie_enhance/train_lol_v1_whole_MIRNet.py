...
from utils import PSNR, adjust_learning_rate, validation_mir2, LossNetwork, visualization

parser = argparse.ArgumentParser()
parser.add_argument('--gpu_id', type=str, default=1)
parser.add_argument('--img_path', type=str, default='/home/wsz/workspace/Data/LOLdataset/curve485/low/')
parser.add_argument('--img_val_path', type=str, default='/home/wsz/workspace/Data/LOLdataset/curve15/low/')

parser.add_argument('--batch_size', type=int, default=1)
parser.add_argument('--lr', type=float, default=2e-4)
parser.add_argument('--weight_decay', type=float, default=1e-8)
parser.add_argument('--pretrain_dir', type=str, default='/home/wsz/workspace/Illumination-Adaptive-Transformer/IAT_enhance/workdirs/snapshots_folder_lol_mirnet_20230603/best_Epoch.pth')
parser.add_argument('--num_epochs', type=int, default=500)
parser.add_argument('--display_iter', type=int, default=10)
parser.add_argument('--snapshots_folder', type=str, default="workdirs/snapshots_folder_lol_mirnet_20230603")
...
for epoch in range(config.num_epochs):
    ...
    # Evaluation Model
    model.eval()
    PSNR_mean, SSIM_mean = validation_mir2(model, val_loader)
