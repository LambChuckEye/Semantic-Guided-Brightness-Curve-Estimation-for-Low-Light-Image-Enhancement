...
parser.add_argument('--img_path', type=str, default='/home/wsz/workspace/Data/LOL_v2/our485/low/')
parser.add_argument('--img_val_path', type=str, default='/home/wsz/workspace/Data/LOL_v2/eval15/low/')
...
parser.add_argument('--snapshots_folder', type=str, default="workdirs/snapshots_folder_lolv2_SAM_20230607")
print("只使用curve进行训练")
