...
# 使用pw dw的zeroDCE模型
# from model.IAT_local_impl_zero import IAT

# 使用pw dw的zeroDCE模型，带偏置
...
parser.add_argument('--img_path', type=str, default='/home/wsz/workspace/Data/LOLdataset/our485_patch/low/')
...
parser.add_argument('--snapshots_folder', type=str, default="workdirs/snapshots_folder_lol_v1_patch_unet_weight_wo_globel_221006")
...
# ! Model Setting，取消/使用全局分支
model = IAT(with_global=False).cuda()
