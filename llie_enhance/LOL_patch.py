...
parser.add_argument('--src_dir', default='/home/wsz/workspace/Data/LOLdataset/eval15', type=str, help='Directory for full resolution images')    # For LOL-V1
parser.add_argument('--tar_dir', default='/home/wsz/workspace/Data/LOLdataset/eval15_patch',type=str, help='Directory for image patches')
