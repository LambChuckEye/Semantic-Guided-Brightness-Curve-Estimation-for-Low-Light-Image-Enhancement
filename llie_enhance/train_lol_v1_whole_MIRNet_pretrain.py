...
parser.add_argument('--img_path', type=str, default='/home/wsz/workspace/Data/SAM_test/our485/low/')
parser.add_argument('--img_val_path', type=str, default='/home/wsz/workspace/Data/SAM_test/eval15/low/')
...
parser.add_argument('--snapshots_folder', type=str, default="workdirs/snapshots_folder_lolv1_SAM_2023052")
print("只使用curve进行训练")
